    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            stranke.Add(new Stranka("SDA", "Izetbegović za predsjednika!",
                                   new List<Kandidat>() { new Kandidat("Bakir", "Izetbegović", false),       new Kandidat("Sebija", "Izetbegović", false),
            ...
            for (; ; )
            {
                ...
                {
                    Console.WriteLine("Ime:"); string ime = Console.ReadLine(); Console.WriteLine("Prezime:");        string prezime = Console.ReadLine();
                    Console.WriteLine("Adresa stanovanja:");     string adresaStanovanja = Console.ReadLine();
                    Console.WriteLine("Datum rođenja (mm/dd/gggg):");         DateTime datum = Convert.ToDateTime(Console.ReadLine());
    ...
    foreach (Stranka s in stranke)
    {
        ...
        foreach (Kandidat k in kandidati)
        {
            ...
            j++;
                        ...
                        {var numbers = kandidatiS?.Split(',')?.Select(Int32.Parse)?.ToList(); List<Kandidat> izabraniKandidati = new List<Kandidat>();
