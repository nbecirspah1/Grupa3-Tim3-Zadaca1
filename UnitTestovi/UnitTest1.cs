...
namespace UnitTestovi
{
   ...
   // }
    ...
    // Unit testovi za White Box testiranje
    [TestClass]
    public class UnitTest8
    {
        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeUnijetoIme()
        {
            Glasac glasac = new("", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeUnijetoPrezime()
        {
            Glasac glasac = new("Huse", "", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeUnijetaAdresa()
        {
            Glasac glasac = new("Huse", "Husić", "", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeImeIspravnogFormata()
        {
            Glasac glasac = new("Huse123", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJePrezimeIspravnogFormata()
        {
            Glasac glasac = new("Huse", "Husić123", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiImeImaDovoljanBrojSlova()
        {
            Glasac glasac = new("H", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiImeImaPreviseSlova()
        {
            Glasac glasac = new("HuseHuseHuseHuseHuseHuseHuseHuseHuseHuseHuse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiPrezimeImaDovoljanBrojSlova()
        {
            Glasac glasac = new("Huse", "Hu", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiPrezimeImaPreviseSlova()
        {
            Glasac glasac = new("Huse", "HusićHusićHusićHusićHusićHusićHusićHusićHusićHusićHusić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeDatumRodjenjaUBuducnosti()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(2025, 1, 1), "111J111", "0101025111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeGlasacPunoljetan()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(2012, 1, 1), "111J111", "0101012111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiJeLicnaKartaIspravnogFormata()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111A111", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiLicnaKartaImaPreviseKaraktera()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J1112", "0101993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiMaticniImaPredvidjenoBrojeva()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "01019931111112");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiPrvaDvaBrojaMaticniogOdgovarajuDanuRodjenjaGlasaca()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0201993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiIducaDvaBrojaMaticniogOdgovarajuMjesecuRodjenjaGlasaca()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0102993111111");
        }

        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void TestDaLiIducaTriBrojaMaticniogOdgovarajuGodiniRodjenjaGlasaca()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101994111111");
        }

        [TestMethod]
        public void TestDaLiJeUspjesnoValidiranGlasac()
        {
            Glasac glasac = new("Huse", "Husić", "Adresa", new DateTime(1993, 1, 1), "111J111", "0101993111111");
            Assert.AreEqual("Huse", glasac.Ime);
            Assert.AreEqual("Husić", glasac.Prezime);
        }
    }
}
